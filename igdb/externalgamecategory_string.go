// Code generated by "stringer -type=ExternalGameCategory,ExternalGameMedia"; DO NOT EDIT.
...
func _() {
	...
	_ = x[ExternalXboxGamePassUltimateCloud-54]
	_ = x[ExternalGamejolt-55]
}
...
const (
	...
	_ExternalGameCategory_name_9 = "ExternalXboxGamePassUltimateCloudExternalGamejolt"
)
...
var (
	...
	_ExternalGameCategory_index_9 = [...]uint8{0, 33, 49}
)
...
func (i ExternalGameCategory) String() string {
	...
	case 54 <= i && i <= 55:
		i -= 54
		return _ExternalGameCategory_name_9[_ExternalGameCategory_index_9[i]:_ExternalGameCategory_index_9[i+1]]
	default:
...
func _() {
	...
	// Re-run the stringer command to generate them again.
	var x [1]struct{}
	_ = x[ExternalDigital-1]
	_ = x[ExternalPhysical-2]
}

const _ExternalGameMedia_name = "ExternalDigitalExternalPhysical"

var _ExternalGameMedia_index = [...]uint8{0, 15, 31}

func (i ExternalGameMedia) String() string {
	i -= 1
	if i < 0 || i >= ExternalGameMedia(len(_ExternalGameMedia_index)-1) {
		return "ExternalGameMedia(" + strconv.FormatInt(int64(i+1), 10) + ")"
	}
	return _ExternalGameMedia_name[_ExternalGameMedia_index[i]:_ExternalGameMedia_index[i+1]]
}
